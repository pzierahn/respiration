...
Source: https://github.com/zizheng-guo/RhythmFormer/blob/main/neural_methods/model/base/rrsda.py
"""
import math
import torch
...
class video_BRA(nn.Module):
    ...
    def __init__(self, dim, num_heads=8, t_patch=8, qk_scale=None, topk=4, side_dwconv=3, auto_pad=False,
                 attn_backend='torch'):
        super().__init__()
