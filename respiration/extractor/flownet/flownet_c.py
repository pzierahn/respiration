"""
Source: https://github.com/NVIDIA/flownet2-pytorch/blob/master/networks/FlowNetC.py
"""
...
class FlowNetC(nn.Module):
    def __init__(self, batch_norm: bool = True, fp16: bool = False):
        ...
        self.conv3_1 = conv(batch_norm, 473, 256)
        ...
        self.conv6_1 = conv(batch_norm, 1024, 1024)
