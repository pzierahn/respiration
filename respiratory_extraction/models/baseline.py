...
def acf_adv(pixel_values: list[int],
    ...
    """
    Estimates breathing rate from NN intervals using the Autocorrelation Advanced Method. This method is from the paper
    "Estimation of breathing rate from respiratory sinus arrhythmia: comparison of various methods" by Axel Schäfer and
    Karl W Kratky.
    :param pixel_values: list of pixel values
    :param fps: frames per second
    :param min_freq: minimum frequency
    ...
    relevant_freqs = freqs[respiratory_band]
    ...
    selected_freqs = relevant_freqs[relevant_powers > median_power]
