"""
Sources:
- FlowNetFusion: https://github.com/NVIDIA/flownet2-pytorch/blob/master/networks/FlowNetFusion.py
- FlowNet2Fusion: https://github.com/NVIDIA/flownet2-pytorch/blob/master/models.py
"""
import torch
